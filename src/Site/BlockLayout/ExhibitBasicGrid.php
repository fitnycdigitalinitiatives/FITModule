...
class ExhibitBasicGrid extends AbstractBlockLayout
{
    /**
     * @var HtmlPurifier
     */
    ...
    {
        return 'Exhibit Page with Text and Media Grid'; // @translate
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block, $templateViewScript = 'common/block-layout/exhibit-basic-grid')
    {
