...
class ItemShowcaseHeroCarousel extends AbstractBlockLayout
{
    public function getLabel()
    {
        return 'Item showcase hero carousel'; // @translate
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
        ...
        return $view->partial('common/block-layout/item-showcase-hero-carousel', [
            'block' => $block,
