...
class AssetHero extends AbstractBlockLayout
{
    public function getLabel()
    {
        return 'Asset Hero'; // @translate
    }
    ...
    public function alignmentClassSelect(
        PhpRenderer $view, SitePageBlockRepresentation $block = null
    )
    {
        $alignmentLabels = [
            'default',
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
        ...
        return $view->partial('common/block-layout/asset-hero', [
            'attachments' => $attachments,
